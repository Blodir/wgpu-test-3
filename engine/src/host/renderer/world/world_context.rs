...
use crate::{
    ...
    game::scene_tree::Sun,
    global_paths::{
        SHADER_GI_BLUR_WGSL, SHADER_G_BUFFER_FRAG_WGSL, SHADER_G_BUFFER_SKINNED_VERT_WGSL,
    ...
    host::{
        ...
        world::{
            ...
            pipelines::{
                deferred_lighting::DeferredLightingPipeline, hbgi_reproject::HbgiReprojectPipeline,
