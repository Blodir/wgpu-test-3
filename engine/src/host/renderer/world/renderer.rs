...
impl GBufferTextureViews {
    pub fn new(textures: &GBufferTextures, wgpu_context: &WgpuContext) -> Self {
        todo!()
    }
}
...
struct Buffers {
    ...
    pub sun_shadow_matrix: wgpu::Buffer,
}
...
struct TextureViews {
    ...
    lighting_target: wgpu::TextureView,
