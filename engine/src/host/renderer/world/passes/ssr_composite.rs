...
pub(crate) fn render_ssr_composite_pass(
    ...
    render_pass.set_pipeline(&context.pipelines.ssr_composite.render_pipeline);
    ...
    render_pass.set_bind_group(2, &context.descriptors.bind_groups.ssr_composite.0, &[]);
