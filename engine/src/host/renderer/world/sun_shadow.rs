...
pub const SUN_SHADOW_CASCADE_COUNT: usize = 4;
pub const SUN_SHADOW_MAP_SIZE: u32 = 2048;
pub const SUN_SHADOW_MAX_DISTANCE: f32 = 300.0;
pub const SUN_SHADOW_CASCADE_SPLIT_RATIOS: [f32; SUN_SHADOW_CASCADE_COUNT] = [0.08, 0.2, 0.45, 1.0];

#[repr(C)]
#[derive(Clone, Copy, Pod, Zeroable)]
pub struct SunShadowUniform {
    pub light_view_proj: [[f32; 16]; SUN_SHADOW_CASCADE_COUNT],
...
pub struct PreparedSunShadow {
    pub cascades: [PreparedSunShadowCascade; SUN_SHADOW_CASCADE_COUNT],
}
