...
impl RenderAssetStore {
    ...
    pub fn initialize_placeholders(&mut self, wgpu_context: &WgpuContext) -> PlaceholderTextureIds {
        ...
        let base_color_texture = wgpu_context
            .device
        ...
        let normals_texture = wgpu_context
            .device
            .create_texture(&wgpu::TextureDescriptor {
        ...
        let occlusion_texture = wgpu_context
            .device
            .create_texture(&wgpu::TextureDescriptor {
        ...
        let emissive_texture = wgpu_context
            .device
            .create_texture(&wgpu::TextureDescriptor {
        ...
        let prefiltered_texture = wgpu_context
            .device
            .create_texture(&wgpu::TextureDescriptor {
        ...
        let base_color = self.textures.insert(TextureGpuData {
            texture: base_color_texture,
            texture_view: base_color_view,
        });
        let occlusion = self.textures.insert(TextureGpuData {
            texture: occlusion_texture,
            texture_view: occlusion_view,
        });
        let emissive = self.textures.insert(TextureGpuData {
            texture: emissive_texture,
            texture_view: emissive_view,
        });
        let metallic_roughness = self.textures.insert(TextureGpuData {
            texture: metallic_roughness_texture,
            texture_view: metallic_roughness_view,
        });
        let prefiltered = self.textures.insert(TextureGpuData {
            texture: prefiltered_texture,
            texture_view: prefiltered_view,
        });
        let di = self.textures.insert(TextureGpuData {
            texture: di_texture,
