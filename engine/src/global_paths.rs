...
pub const SHADER_GTAO_WGSL: &str = "engine/src/host/renderer/world/shaders/gtao.wgsl";
...
pub const SHADER_HISTORY_WGSL: &str = "engine/src/host/renderer/world/shaders/history.wgsl";
